...
output="${1:-$repo_root/artifacts/rf-106-0.2.13.rfplugin}"
component="$repo_root/target/wasm32-unknown-unknown/release/rackforge_rf_106.wasm"
stage=""
cleanup() {
